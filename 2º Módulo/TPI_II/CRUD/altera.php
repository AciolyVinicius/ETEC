	...
	<body>
		...
		<section>
			...
			<?php
				...
				$result = $mysqli->query("SELECT * FROM filme");
		...
		<section>
			...
			<form action="alterar.php" method="post">
				Qual código deseja alterar? (preencha todos os campos)<br>
					Código: <input type="text" name="id" size="2" maxlength="2"/><br/>
					Nome: <input type="text" name="nome" size="2" maxlength="2"/><br/>
					Ano: <input type="text" name="ano" size="2" maxlength="2"/><br/>
					<br/>
