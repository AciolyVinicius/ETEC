...
namespace SAGA
{
    public partial class frm_cadastro : Form
    {
        ...
        {
            if (txt_estado.Text != ""&& txt_endereco.Text!="" &&txt_nome.Text != "" && txt_email.Text != "" && txt_senha.Text != "" && txt_cSenha.Text != "" && txt_cpf.Text != "" && txt_rg.Text != "" && txt_contato1.Text != "" && txt_senha.Text.Equals(txt_cSenha.Text) && "" != lst_estado.SelectedItem.ToString())
            {
                String endereco,nome_responsavel, cpf_responsavel, contato_responsavel, email_responsavel, nome, nascimento, senha, cpf, rg, contato1, contato2, email, estado = lst_estado.SelectedItem.ToString();
                int usersrole = 4;
                Boolean stop = true;
                nome = txt_nome.Text;
