        ...
        public Boolean ConfirmRegister()
        {
            ...
            try
            {
                ...
                string inserir = "INSERT INTO users (nome, endereco, email, cpf, rg, passwords, contato1, contato2, responsavel, contato_responsavel, email_responsavel, cpf_responsavel) VALUES" +
                    ...
                    "INSERT INTO role_user (users_id, roles_id) VALUES ( (SELECT u.id  FROM users u RIGHT JOIN role_user ru ON u.id = ru.users_id LEFT JOIN roles r ON ru.roles_id = r.id  WHERE u.email = '" + Cadastro.Email + "' and u.passwords = '" + Cadastro.Senha + "'), " + Cadastro.Usersrole +" );";
