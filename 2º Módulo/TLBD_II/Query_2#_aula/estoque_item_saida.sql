...
CREATE TABLE `item_saida` (
  `qt_saida_produto` tinyint(4) DEFAULT NULL,
  `vl_produto` decimal(9,2) DEFAULT NULL,
  `cd_produto` int(11) DEFAULT NULL,
  `cd_saida` int(11) DEFAULT NULL,
  KEY `fk_item_saida` (`cd_saida`),
  KEY `fk_saida_produto` (`cd_produto`),
  CONSTRAINT `fk_item_saida` FOREIGN KEY (`cd_saida`) REFERENCES `tb_notas_saida` (`cd_saida`),
  CONSTRAINT `fk_saida_produto` FOREIGN KEY (`cd_produto`) REFERENCES `tb_produto` (`cd_produto`)
...
-- Dump completed on 2017-08-18 17:49:23
