...
$html .= "<div class='col-12 col-md-12'>";
$html .= "<label for='descricao' class='control-label'><span class='text-danger'>*</span>Descrição</label>";
$html .= "<div class='form-group'>";
$html .= "<textarea class='form-control' name='descricao' required='' id='descricao' rows='8'></textarea>";
$html .= "<span class='text-danger'></span>";
$html .= "</div>";
$html .= "</div>";
$html .= "</div>";
