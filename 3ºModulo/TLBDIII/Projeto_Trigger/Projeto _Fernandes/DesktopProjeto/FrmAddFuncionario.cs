...
namespace DesktopProjeto
{
    public partial class FrmAddFuncionario : Form
    {
        ...
        {
            if(!txtCidadeFuncionario.Text.Equals(null) && !txtNomeFuncionario.Text.Equals(null) && !txtSalarioFuncionario.Text.Equals(null) && !txtTelefoneFuncionario.Text.Equals(null) && !cmbDepartamentoFuncionario.Text.Equals(null) || !txtCidadeFuncionario.Text.Equals("") && !txtNomeFuncionario.Text.Equals("") && !txtSalarioFuncionario.Text.Equals("") && !txtTelefoneFuncionario.Text.Equals("") && !cmbDepartamentoFuncionario.Text.Equals("")) {
