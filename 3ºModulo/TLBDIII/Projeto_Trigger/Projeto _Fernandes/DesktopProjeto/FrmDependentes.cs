...
namespace DesktopProjeto
{
    public partial class FrmDependentes : Form
    {
        ...
        {
            if (Application.OpenForms.OfType<FrmAddDependente>().Count() > 0)
            {
                Form segundo = Application.OpenForms["FrmAddDependente"];
                segundo.Show();
                this.Hide();
            }
            else
        ...
        {
            if (Application.OpenForms.OfType<FrmEditDependente>().Count() > 0)
            {
                Form segundo = Application.OpenForms["FrmEditDependente"];
                segundo.Show();
                this.Hide();
            }
            else
        ...
        {
            if (Application.OpenForms.OfType<FrmShowDependente>().Count() > 0)
            {
                Form segundo = Application.OpenForms["FrmShowDependente"];
                segundo.Show();
                this.Hide();
            }
            else
