...
public class TabelaAcervo extends AbstractTableModel {
    ...
    private List<Acervo>linhasT;
    private String [] colunasT = {"Código","Título","Autor", "Editora"};
    
    
    public TabelaAcervo() {
        linhasT = new ArrayList<Acervo>();
    }
    
    public TabelaAcervo(List<Acervo>listagem) {
        
        linhasT = new ArrayList<Acervo>(listagem);
    }
    ...
    public Object getValueAt(int indiceLinha, int indiceColuna) {
        if(linhasT != null){
            ...
            Acervo a1 = linhasT.get(indiceLinha);
    ...
    public void addAcervo(Acervo a1){
        linhasT.add(a1);
